...
namespace WhereAreThem.WinViewer.ValueConverter {
    /// <summary>
    ...
    public static class MultiSelectorBehaviours {
        public static readonly DependencyProperty SynchronizedSelectedItems = DependencyProperty.RegisterAttached(
            "SynchronizedSelectedItems", typeof(IList), typeof(MultiSelectorBehaviours), new PropertyMetadata(OnSynchronizedSelectedItemsChanged));
